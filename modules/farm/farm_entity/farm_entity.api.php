...
/**
 * @defgroup farm_entity Farm entity module integrations.
 *
 * Module integrations with the farm_entity module.
 */

/**
 * @defgroup farm_entity_hooks Farm entity's hooks
 * @{
  ...
  $entities = array(
    ...
    'log' => array(
      ...
      'farm_seeding' => array(
        ...
        /**
         * @see hook_farm_entity_entity_views()
         */
        'weight' => 10,
      ),
    ),
